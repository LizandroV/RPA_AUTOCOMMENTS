...
link = "https://g.page/r/CW_g4xn4Wq3REBM/review"
...
try:
    ...
    if exists("1689627403396.png",5):
        ...
        sleep(2)
        type("w",KEY_CTRL)
    if exists(Pattern("1689627598892-1.png").similar(0.90)):
    ...
    elif exists(Pattern("1689702472275-1.png").similar(0.90),5):
        print("NO HAY COMENTARIO")
        click(Pattern("1689702472275-1.png").targetOffset(104,4))
        sleep(2)
